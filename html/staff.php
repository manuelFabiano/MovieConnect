...
<button type="button" onclick="location.href='./dashboard.php'" class="self-start mb-96 transition duration-200 ml-36 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-200 ring-inset">
        ...
        <div class="justify-self-center absolute bg-white w-4/5 h-min rounded-2xl items-center flex flex-col shadow-2xl p-7">
          ...
          <?if($_SESSION['tipo'] == 2 ){?>
            ...
            <?}?>
            <button type="button" onclick="location.href='./add_film.php'" class="py-5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200">Inserisci un film o una serie</button>
